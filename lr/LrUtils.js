...
*/
const dref = (o, ...a) => a.reduce((xs, x) => (xs && xs[x] ? xs[x] : undefined), o);

let LrUtils = {

	// utility to derefernce a chain with possible nulls
	dref:  dref,
	...
	logAlbumP: async (lr, album, offset = '') => {
		...
		let remoteId = dref(album,'payload','publishInfo','remoteId')
